...
public class MessageBuilderTest {
    ...
    public void buildsTextmessage() {
        ...
        //then
        String expectedMessage = "{\"type\":\"textMessage\",\"primeData\":{\"chatID\":\"" + ChatServer.LobbyID + "\",\"message\":\"<article><b>User1<\\/b> Hallo, wie geht es dir ?<p><small class=\\\"text-muted\\\">" + MessageBuilder.getTimestamp(date) + "<\\/small><\\/p><\\/article>\"}}";

...
public class SearchUserSteps {
    ...
    public void werdenBeiDieBenutzerAngezeigt(String webDriver, List<String> onlineUsers) throws Throwable {
        for (String username : userList) {
            Assert.assertThat(client.get(webDriver).findElement(By.id("user_" + username.hashCode())).getAttribute("style"), CoreMatchers.is((onlineUsers.contains(username)) ? "display: block;" : "display: none;"));
        }
    }
}
